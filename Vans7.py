...
def help():
    ...
    key = key.title()
    helpMessage = "🔰➣ " + key + " [BLACK-ROSES-TEAM--MΣΠU]🔰🔰\n" + \
                  "🔰➣" + key + "🔯BLACK-ROSES-TEAM🔯\n" + \
                  "🔰➣" + key + "ʜᴇʟᴘ\n" + \
                  "🔰➣" + key + "ʜᴇʟᴘ1\n" + \
                  "🔰➣" + key + "ʜᴇʟᴘ2\n" + \
                  "🔰➣" + key + "ʜᴇʟᴘ3\n" + \
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "🔰 " + key + " [BLACK-ROSES-TEAM🔀MΣΠU]🔰\n" + \
                  "🔰" + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "🔰" + key + "ɢɪɴғᴏ\n" + \
                  "🔰" + key + "ᴏᴘᴇɴ\n" + \
                  "🔰" + key + "ᴄʟᴏsᴇ\n" + \
                  ...
                  "🔰🔰🔰「」↪  ʙʏ: Van'S ↩ 🔰🔰🔰\n" + \
                  "🔀 Creator:  https://line.me/ti/p/~indahcintaku19"
...
def help2():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage2= "🎞🎞「🔳SΣTTIΠG-BLACK-ROSES-TEAM🔳」🎞🎞\n" + \
                  "🎴➣ " + key + "ɪɴᴠɪᴛᴇ「ᴏɴ/ᴏғғ」\n" + \
                  "🎴➣ " + key + "sᴛɪᴄᴋᴇʀ「ᴏɴ/ᴏғғ」\n" + \
                  "🎴➣" + key + "ᴜɴsᴇɴᴅ「ᴏɴ/ᴏғғ」\n" + \
                  "🎴➣ " + key + "sɪᴅᴇʀ「ᴏɴ/ᴏғғ」\n" + \
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴋᴀɴ ᴀɴɢɢᴏᴛᴀ ʙᴏᴛs BLACKROSESTEAM")
#UPDATE FOTO
               if msg.contentType == 1:
                 if msg._from in admin:
...
#KICKALL
                        ...
                        elif "!blackrose" in msg.text:                      	
                           if msg._from in Bots:
                            if msg.toType == 2:
                               print                               
                               _name = msg.text.replace("!blackrose","")
...
">>>lain x jangan sok songong ama kami>><\ningat  yee,,klo lu dendam cari kami\n<<<<<<<<<>>\nhttp://line.me/ti/p/~indahcintaku19")
                     ...
                     #   elif cmd == "reinvite":
                        ...
                        elif cmd == "BLACKROSES" or cmd == "BRTbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[BLACK-ROSES-TEAM].")
                               elapsed_time = time.time() - start
...
">>>lain x jangan sok songong ama kami>><\ningat  yee,,klo lu dendam cari kami\n<<<<<<<<<>>\nhttp://line.me/ti/p/~indahcintaku19")
                    ...
                    #    elif cmd == "terx.reinvite":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                ki.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                kk.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                kc.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                kb.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                kd.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                ke.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                kf.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                kj.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                                sw.sendMessage(msg.to, "🔯BLACK ROSES TEAM🔯")
                            #    cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
...
#===========BOT UPDATE============#
                        elif msg.text in ["Nek","Tagall","Desah","Tag","Assalamualaikum","Tag all","Siang","Sore","Malam","Pagi","Nahh","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
...
#===========Hiburan============#
                        ...
                        elif cmd == "BRTbot" or cmd == "BRTbots":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                ki.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                kk.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                kc.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                kb.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                kd.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                ke.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                kf.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                kj.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                sw.sendMessage(msg.to, "тeaм BLACKROSE нadιr")
                                cl.sendMessage(msg.to, "тeaм BLACKROSE all ready\nAmankan Room\nDemi Amanatnya Bos ")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                Ticket = cl.reissueGroupTicket(msg.to)
                                kj.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kj.sendMessage(msg.to, "BLACKROSES "+str(G.name))
                                sw.acceptGroupInvitationByTicket(msg.to,Ticket)
                                sw.sendMessage(msg.to, "BLACKROSES "+str(G.name))
                                G = sw.getGroup(msg.to)
                                G.preventedJoinByTicket = True
                                sw.updateGroup(G)
...
">>>lain x jangan sok songong ama kami>><\ningat  yee,,klo lu dendam cari kami\n<<<<<<<<<>>\nhttp://line.me/ti/p/~indahcintaku19")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[BLACKROSES")
                               elapsed_time = time.time() - start
